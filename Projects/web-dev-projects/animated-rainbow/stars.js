(() => {
    ...
    // Updated star configuration
    const cfg = {
        layers: [
            { count: 500, sizeMin: 0.3, sizeMax: 0.8 },   // small stars - increased
            { count: 100, sizeMin: 0.8, sizeMax: 1.5 },    // medium stars - increased
            { count: 20, sizeMin: 1.5, sizeMax: 2 }     // large stars - unchanged
        ]
    };
